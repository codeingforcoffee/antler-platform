...
export const enUS: Translations = {
  ...
  welcome: {
    ...
    description:
      "Welcome to 🦌 Antler Platform, an open source super agent. With built-in and custom skills, Antler Platform helps you search on the web, analyze data, and generate artifacts like slides, web pages and do almost anything.",

    createYourOwnSkill: "Create Your Own Skill",
    createYourOwnSkillDescription:
      "Create your own skill to release the power of Antler Platform. With customized skills,\nAntler Platform can help you search on the web, analyze data, and generate\n artifacts like slides, web pages and do almost anything.",
  },
  ...
  console: {
    title: "Console",
    subtitle:
      "Runs, token spend, and assets across every conversation — live from the platform runtime.",
    statTokens: "Total tokens",
    statTokensHint: "last {days} days: {tokens}",
    statCost: "Total cost",
    statCostHint: "last {days} days: {cost}",
    pricingNotConfigured: "Set models[].pricing in config.yaml",
    statRuns: "Total runs",
    statRunsActive: "{count} active",
    statRunsFailed: "{count} failed",
    statThreads: "Conversations",
    statAgents: "Agents",
    usageTitle: "Token usage",
    usageSubtitle: "Daily consumption over the last {days} days",
    byModel: "By model",
    cacheHit: "cache hit {pct}%",
    noUsage: "No usage recorded in this window yet.",
    runsTitle: "Recent runs",
    runsSubtitle: "Every run across your threads, newest first",
    colStatus: "Status",
    ...
    empty: "No runs yet",
    emptyHint: "Start a chat and its runs will show up here.",
    pagePrev: "Previous",
    pageNext: "Next",
    unavailableTitle: "Console needs a SQL database",
    unavailableHint:
      "Set database.backend to sqlite or postgres in config.yaml, then restart the gateway.",
  ...
  agents: {
    ...
    saving: "Saving agent...",
    saveRequested:
      "Save requested. Antler Platform is generating and saving an initial version now.",
    saveHint:
    ...
    agentCreatedPendingRefresh:
      "The agent was created, but Antler Platform could not load it yet. Please refresh this page in a moment.",
    more: "More actions",
  ...
  channels: {
    ...
    descriptions: {
      telegram: "Telegram direct messages through your Antler Platform bot.",
      slack: "Slack workspace messages and mentions.",
      discord: "Discord server messages through your Antler Platform bot.",
      feishu: "Feishu and Lark messages through your Antler Platform app.",
      dingtalk:
        "DingTalk Stream Push messages through your Antler Platform bot.",
      wechat: "WeChat iLink messages through your Antler Platform bot.",
      wecom: "WeCom messages through your Antler Platform AI bot.",
    },
  ...
  toolCalls: {
    ...
    skillInstallTooltip:
      "Install skill and make it available to Antler Platform",
  },
  ...
  shortcuts: {
    ...
    keyboardShortcutsDescription:
      "Navigate Antler Platform faster with keyboard shortcuts.",
  ...
  settings: {
    title: "Settings",
    description: "Adjust how Antler Platform looks and behaves for you.",
    sections: {
      account: "Account",
    ...
    memory: {
      title: "Memory",
      description:
        "Antler Platform automatically learns from your conversations in the background. These memories help Antler Platform understand you better and deliver a more personalized experience.",
    ...
    channels: {
      title: "Channels",
      description:
        "Connect IM accounts that can send messages to Antler Platform from outside the browser.",
      disabled:
    ...
    skills: {
      ...
      emptyDescription:
        "Put your agent skill folders under the `/skills/custom` folder under the root folder of Antler Platform.",
    ...
    notification: {
      title: "Notification",
      description:
        "Antler Platform only sends a completion notification when the window is not active. This is especially useful for long-running tasks so you can switch to other work and get notified when done.",
    ...
    account: {
      ...
      ssoPasswordMessage:
        "This account signs in with {provider}, so Antler Platform cannot manage or change its password here. Use your SSO provider's account settings instead.",
  ...
  login: {
    ...
    adminSetupRequiredDescription:
      "Antler Platform needs an administrator account before new regular accounts can be created.",
