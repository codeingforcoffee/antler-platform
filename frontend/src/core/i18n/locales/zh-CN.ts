...
export const zhCN: Translations = {
  ...
  welcome: {
    greeting: "你好，欢迎回来！",
    description:
      "欢迎使用 🦌 Antler Platform，一个完全开源的超级智能体。通过内置和自定义的 Skills，\nAntler Platform 可以帮你搜索网络、分析数据，还能为你生成幻灯片、\n图片、视频、播客及网页等，几乎可以做任何事情。",

    createYourOwnSkill: "创建你自己的 Agent SKill",
    createYourOwnSkillDescription:
      "创建你的 Agent Skill 来释放 Antler Platform 的潜力。通过自定义技能，Antler Platform\n可以帮你搜索网络、分析数据，还能为你生成幻灯片、\n网页等作品，几乎可以做任何事情。",
  },
  ...
  console: {
    title: "控制台",
    subtitle:
      "全部会话的运行、Token 消耗与资产总览——来自平台运行时的实时数据。",
    statTokens: "累计 Token",
    statTokensHint: "近 {days} 天:{tokens}",
    statCost: "累计费用",
    statCostHint: "近 {days} 天:{cost}",
    pricingNotConfigured: "在 config.yaml 的 models[].pricing 配置单价",
    statRuns: "运行总数",
    statRunsActive: "进行中 {count}",
    statRunsFailed: "失败 {count}",
    statThreads: "会话数",
    statAgents: "智能体",
    usageTitle: "Token 用量",
    ...
    empty: "暂无运行记录",
    emptyHint: "发起一次对话后,这里会实时展示它的运行。",
    pagePrev: "上一页",
    pageNext: "下一页",
    unavailableTitle: "控制台需要 SQL 数据库",
    unavailableHint:
      "请在 config.yaml 中将 database.backend 设为 sqlite 或 postgres,然后重启 Gateway。",
  ...
  agents: {
    ...
    saving: "正在保存智能体...",
    saveRequested:
      "已提交保存请求，Antler Platform 正在根据当前对话生成并保存初版智能体。",
    saveHint:
    ...
    agentCreatedPendingRefresh:
      "智能体已创建，但 Antler Platform 暂时还无法读取到它。请稍后刷新当前页面。",
    more: "更多操作",
    agentCreated: "智能体已创建！",
    startChatting: "开始对话",
  ...
  // Workspace
  workspace: {
    officialWebsite: "访问 Antler Platform 官方网站",
    githubTooltip: "访问 Antler Platform 的 Github 仓库",
    settingsAndMore: "设置和更多",
    visitGithub: "在 Github 上查看 Antler Platform",
    reportIssue: "报告问题",
    contactUs: "联系我们",
    about: "关于 Antler Platform",
    logout: "退出登录",
  ...
  channels: {
    ...
    saveChanges: "保存修改",
    descriptions: {
      telegram: "通过 Antler Platform Bot 接收 Telegram 私聊消息。",
      slack: "接收 Slack 工作区消息和提及。",
      discord: "通过 Antler Platform Bot 接收 Discord 服务器消息。",
      feishu: "通过 Antler Platform 应用接收飞书和 Lark 消息。",
      dingtalk: "通过 Antler Platform Bot 接收钉钉 Stream Push 消息。",
      wechat: "通过 Antler Platform Bot 接收微信 iLink 消息。",
      wecom: "通过 Antler Platform AI Bot 接收企业微信消息。",
    },
  ...
  toolCalls: {
    ...
    skillInstallTooltip: "安装技能并使其可在 Antler Platform 中使用",
  },
  ...
  shortcuts: {
    ...
    keyboardShortcutsDescription: "使用键盘快捷键更快地操作 Antler Platform。",
  ...
  settings: {
    title: "设置",
    description: "根据你的偏好调整 Antler Platform 的界面和行为。",
    sections: {
      account: "账号",
      appearance: "外观",
      channels: "渠道",
    ...
    memory: {
      title: "记忆",
      description:
        "Antler Platform 会在后台不断从你的对话中自动学习。这些记忆能帮助 Antler Platform 更好地理解你，并提供更个性化的体验。",
      empty: "暂无可展示的记忆数据。",
      rawJson: "原始 JSON",
      exportButton: "导出记忆",
      exportSuccess: "记忆已导出",
    ...
    channels: {
      title: "渠道",
      description:
        "连接可在浏览器外向 Antler Platform 发送消息的即时通讯账号。",
      disabled:
    ...
    skills: {
      ...
      emptyTitle: "还没有技能",
      emptyDescription:
        "将你的 Agent Skill 文件夹放在 Antler Platform 根目录下的 `/skills/custom` 文件夹中。",
    ...
    notification: {
      title: "通知",
      description:
        "Antler Platform 只会在窗口不活跃时发送完成通知，特别适合长时间任务：你可以先去做别的事，完成后会收到提醒。",
    ...
    account: {
      ...
      ssoPasswordMessage:
        "此账号通过 {provider} 登录，Antler Platform 无法在此管理或修改密码。请前往你的 SSO 提供商账号设置中进行操作。",
  ...
  login: {
    ...
    adminSetupRequiredDescription:
      "Antler Platform 需要先创建管理员账号，然后才能创建新的普通账号。",
